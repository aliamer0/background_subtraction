...
int main() {
    ...
    Mat fg1(rows, cols, type, Scalar(0));
    Mat fg2(rows, cols, type, Scalar(0));
    Mat fg3(rows, cols, type, Scalar(0));
    Mat fg4(rows, cols, type, Scalar(0));
    Mat fg5(rows, cols, type, Scalar(0));
